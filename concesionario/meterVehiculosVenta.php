...
<head>
    ...
    <title>meter vehiculos venta</title>
...
if ($error == 0) {
    ...
    if ($error == 0) {
        ...
        $insert_query = "INSERT into vehiculo_venda(modelo, cantidade, descricion, marca, prezo, foto) VALUES ('$modelo',$cantidade,'$descricion','$marca',$prezo,'$cadenaImg');";
        if (mysqli_query($mysqli_link, $insert_query)) {
            echo "nuevo vehiculo disponible en venta <br>";
            echo '<a href="menu.php">volver al menu</a>';
        }
    } elseif ($error == 1) {
        echo '<br><a href="meterVehiculosVenda.php">try again</a>';
    }
