...
<meta http-equiv="Content-type" content="text/html; charset=utf-8" />
		<title>Modificar Vehiculo Venta</title>
...
<body>
    ...
    <p style="color:blue;text-align:right;">
		...
		<form name="modificarVehiculoVenta" method="post" action="modificarVehiculoVenda.php">
			...
			<input type="submit" value="modificarVehiculoVenta" />
		</form>
